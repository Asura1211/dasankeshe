    ...
    <div>
      ...
      <el-dropdown>
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item @click.native="sortByPrice"
            >按价格</el-dropdown-item
          >
      ...
      <el-radio-group v-model="radio" fill="#FFCD56">
        ...
        <el-radio-button
          label="主食"
          @click.native="
            dataInPage = goodsList.filter(data => '主食' === data.type)
          "
        ></el-radio-button>
        <el-radio-button
          label="小吃"
          @click.native="
            dataInPage = goodsList.filter(data => '小吃' === data.type)
          "
        ></el-radio-button>
        <el-radio-button
          label="饮料"
          @click.native="
            dataInPage = goodsList.filter(data => '饮料' === data.type)
          "
        ></el-radio-button>
      </el-radio-group>
      <el-autocomplete
      ...
      <el-card :body-style="{ padding: '0px' }" shadow="hover" class="card">
        <el-container>
          ...
          <el-container>
            ...
            <el-main>
              <span style="float: left;color:#FFCD56; font-weight: bolder;"
                >￥{{ o.price }}</span
              >
              <el-button
                type="danger"
      ...
      goodsList: [
        {
          ...
          value: "炒面",
          pictureUrl:
            "http://localhost:8080/takeout/upload/201907011702352.jpg",
          praise: 0,
          price: 200,
          sid: 1,
          stock: 1,
  ...
  methods: {
    ...
    querySearch(queryString, cb) {
      ...
      let results = queryString
        ? goods.filter(this.createFilter(queryString))
        : goods;
    ...
    createFilter(queryString) {
      return good => {
        return (
          good.name.toLowerCase().indexOf(queryString.toLowerCase()) !== -1
        );
      };
    },
    handleSelect(item) {
